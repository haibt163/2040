...
The house asked Tomiko if she wanted chamomile or hojicha.
...
# B. EDITORIAL CHANGE LOG

**Removed**
- Cut trailing explanatory clauses that restated what the scene already showed: "...and Chiho had made her peace with this arithmetic some years ago" (Kenji intro); "which was its own kind of accommodation" (counter-eating); "making sure the record was accurate" (late-night tea scene); "He had always given you an option while making clear he had a preference" (filter note); "and in the process she would have figured out what she actually thought" (Data Continuity Act line).
- Trimmed "in a vague background way" to "vaguely"; "still testing the new certainty" to "still testing."

**Rhythm / sentence variation**
- Combined/restructured several passages using em-dashes and colons in place of repeated "which was" / "the way X" constructions (commuting passage; "Nobody had asked it to do this" passage; two instances of "the way she said..." dialogue tags).
- Varied a duplicated "He was like that" occurring twice in close proximity in the clinic scene (first instance changed to "Your father was the same").
- Combined two short sentences on the Sunday-music realization into one.

**Akira**
- Added one small, unexplained habit via Tomiko in the lacquer-box scene: he never let the rice cooker finish beeping, always opening it a few seconds early. Followed by a brief, unembellished reaction from Chiho, with no thematic gloss attached.

**Kenji**
- Added one concrete human detail to his reply in the Saturday text exchange: he answers near midnight, apologizing, because one of his kids had a fever.

**Chiho**
- Added one paragraph after the billing discovery where she recognizes the evergreen/renewal-by-default contract structure from her own procurement work — brief, embedded in her reaction, not expository.

**Other essential micro-edits**
- Restored missing quotation marks around Tomiko's remembered line about rain and the weather model (formatting/continuity fix, not stylistic).