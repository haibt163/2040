...
export default function Home() {
  ...
  const wordCount = useMemo(() => story.body.trim().split(/\s+/).length, []);
        ...
        <div className="section-grid">
          ...
          <div className="premise-copy">
            <p id="premise-title" className="premise-lede">
              The future does not arrive with an announcement. It becomes the
              background.
            </p>

            <p>
              The Persistence Term follows Yuki, a home-care worker in Setagaya,
              whose phone keeps scheduling the life of her daughter Hana nine
              months after her death.
            </p>

            <p>
              Behind that small error is an allocation system built to
              distribute intelligence fairly — and a judgment about whether
              grief should count as productive time. What begins as a
              discrepancy becomes a question about memory, care, and the
              markets that grow around both.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="note" className="closing section-pad">
        <div className="section-grid">
          ...
          <div className="closing-copy">
            ...
            <p>
              This is a living draft. The story, its world, and this page are
              intended to evolve together.
            </p>
